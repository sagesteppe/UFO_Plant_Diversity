...
cvals <- read.csv(file.path(ppro, fp[grep('C-Values', fp)])) %>% 
  select(National_USDASymbol, FQA_C.Value2020_Numeric, FQA_NativeStatus, Ack_SciName_noAuthority, USDA_Duration)
...
Equations from @swink1994plants, modified for more simple formulations. 
