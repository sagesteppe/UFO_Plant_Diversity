...
model_26 <- glm(formula = mcoc_r ~ elevation + road_dist + xcoord + 1, data = fqa_rast_vals)
...
top_pred_r <- c(
  ...
  pred_26 <- predict(pred_stack, model_26, type="response"),
...
rm(model_18, model_20, model_24, model_28, model_26, oop, pred_20, pred_18, pred_26, model_terms)
```
...
m_list <- list(model_20, model_18, model_26 )
