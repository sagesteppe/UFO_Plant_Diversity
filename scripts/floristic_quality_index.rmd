...
summary(model.avg(optimal_models)) |> knitr::kable()
...
top_pred_r <- subset(top_pred_r, c(1:3, 5)) # we can remove it here
top_pred_r <- mean(top_pred_r)
plot(top_pred_r)

# create a simple ensemble, by calculating the mean of each top model

rm(model_18, model_20, model_24, model_28, model_52, oop, pred_20, pred_18, pred_28, pred_24, pred_52)
```
...
m_list <- list(model_20, model_18, model_28, model_24, model_52 )
...
rm(fqa_rast_vals, model_18, model_20, model_24, model_28, model_52, optimal_models, pred_stack)
```
