...
Wherein the number of species which are shared ("$\cap$") between two sites are multipled by 2, and divided by the total number of species at both sites.
