...
##### Population Size -
The BIEN data were split into two constituent portions, the first being records which were contributed from herbaria, and the others records from from survey based monitoring work. Raster cells were made more coarse, to 16km^2^, to avoid having many 0 records. All plot based records from across all species were combined, and each raster cell which contained the presence of a plot was used for future analyses. For each species, if a plot based record was located in a cell, it was classified as having a high population, if only an herbarium collection was present it was classified as having a low population. 
