...
sp_clean <- bind_rows(sp_clean, sp_clean_1) 
# we will use this dataset going foward,

rm(sp_clean_1, CO_plants)
```
...
```{r}
blm <- tracked %>% filter(BLM_RANK == T)
```


### NatureServe Rare Species at State and Global
