...
Whereas shrubs are expected to be greatly reduced in the Salt Desert, especially areas which have historically been composed primarily of shadscale (*Atriplex* spp.). 
...
Many historical vegetation treatments, especially for Pinyon-Juniper forests, were conducted throughout the study area (). However, akin to a great proportion of other such treatments globally, most of these were marginally effective (@). This is likely due to the potential of those ecological sites not including a mixed grass and shrubland more desirable for livestock use ().  Many portions of the study area ARE Pj sites.., 
