...
It is difficult to determine the extent to which grasses of the Colorado Plateau will reduce their growth in response to drought. Various studies have found that grass production decreases during drought, and during periods of highly variable precipitation (@gherardi2015enhanced, @staver2019grazer, @munson2022primary). Whereas other studies show that the amount of biomass produced by grasses is quite resilient to drought (@byrne2017contrasting), and that moisture limitation reductions in grass growth are largely buffered by legacy effects (in this case, a single normal year of precipitation can offset the next few years of dryness and *vice versa*; a year like 2018 SECTION XX) (@sala2012legacies, @reichmann2013precipitation).  From the complications in drawing a clear line across the effects, we expect that drought would have had moderate effects on reducing the cover of perennial grasses, and that cover would be expected beneath the midpoint of variation for this benchmark.

Recent studies limited to the Colorado Plateau have shown reduced growth of C4 grasses, partially due to variability in Monsoons (?), and C3 grasses via reduced cool season precipitation (@munson2022primary, @hoover2021drought) ... However, given the distinctive growth forms of grasses (i.e. generally columnar), it is unlikely that their cover would be found to be lower via the methods employed by AIM, unless high levels of mortality occurred. 

Compared to perennial forb duration, perennial grasses appear to live for considerable longer, form 4 - 7 decades (@lauenroth2008demography, @treshow1974longevity), and while the recruitment of new grass individuals is likely moisture limited, it is unlikely that as considerably high a proportion of the members of this functional group would have died off over this period, independent of drought induced mortality (@morris2008longevity). 

Mortality of grasses due to drought is now expected ... Similar to forbs, soil textures and depths (@chamrad1965drought, @griffin2012mortality) are able to mediate drought effects. Highest mortality are to be expected on Ecological Sits with coarse grained (sandy) and shallow soils. 
