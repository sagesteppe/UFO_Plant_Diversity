...
# we will need to add the MEDIAN value to all ESD's missing the real estimates. 
# and then we drop unused ESD levels, and plot from there. 
...
forb_bench <- benchmarks %>% 
  ...
  geom_point(data = all_hits_nat, aes(x = Cover_HB, y = fct_reorder(ECO.SITE, Cover_HB)), alpha = 0.4) +
