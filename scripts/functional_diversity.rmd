...
```{r Extract the Main Species Attributes from AIM database}
...
spp_attri <- spp_attri %>% 
  mutate(SYMBOL = case_when(
    ...
    SYMBOL == 'AGHE2' ~ 'AGHEH',
    SYMBOL == 'ARHI' ~ 'ARHIP',
    SYMBOL == 'ARFEF' ~ 'ARFE', # arenaria also possible, but generally higher
    SYMBOL == 'ASCH4' ~ 'ASCHC2',
    SYMBOL == 'ARSP5' ~ 'PIDE4',
    SYMBOL == 'ASAM5' ~ 'ASAMV',
    SYMBOL == 'AMDI5' ~ 'BADI',
...
out <- left_join(spp_attri, nativity, by = 'SYMBOL') %>% 
  distinct(SYMBOL, .keep_all = T)

# not known from CO yet, 
# BRAN , SIIR , ERAB3, ERRO2 - LIKELY E. STRICTUM, THPU3, 
# ASASC - MISTYPED ASTRAGALUS ASCLEPI..?,  # DRPA, # BOAR
