...
benchmarks <- esg_cover %>% 
  ...
  mutate(ESTIMATE = 'LOWER', COVER_RANGE = 'ORIGINAL', MEAN = COVER, SET = 'ESG') %>% 
...
forb_bench <- benchmarks %>% 
  ...
  geom_jitter(data = all_hits_nat, height = 0.2,
...
#    position = position_dodge2(width = 0.5), size = 0.2, alpha = 0.4, linetype = 'dotted')  +
  ...
  scale_color_manual(values = c("ESD" = '#860FAE', "ESG" = "#da008d")) +
