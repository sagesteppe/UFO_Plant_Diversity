...
home_brew <- all_hits_w  %>% 
  mutate(Forb = sum(NonNoxAnnForbCover, NonNoxPerenForbCover, 
                             NoxPerenForbCover, NoxAnnForbCover),
         Grass = sum(NonNoxAnnGrassCover, NonNoxPerenGrassCover, 
                             NoxPerenGrassCover, NoxAnnGrassCover),
         PerenGrass = sum(NonNoxPerenGrassCover, NoxPerenGrassCover), 
         ShrubCover = sum(NonNoxShrubCover, NoxShrubCover, NoxSubShrubCover),
